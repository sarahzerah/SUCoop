        ...
        <form class="form-validate form-horizontal " method="POST" action="transactions.php">
            <div class="form-group ">
                     ...
                     <div class="input-group">
                       <span class="input-group-addon success" class="btn btn-primary" >Search</span>
            ...
            <section class="panel">
                <header class="panel-heading"><h4><b>Credit Payment</b></h4></header>
                          ...
                          <div class="panel-body">
                              <div class="form-group">
                                  <div class="col-lg-offset-2 col-lg-6">
                                      <input class="btn btn-primary" type="submit" name="cpayment" value="Save">
