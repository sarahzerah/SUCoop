<div class="row">
    <div class="col-lg-8">
        <form class="form-validate form-horizontal " method="POST" action="transactions.php">
            ...
            <section class="panel">
                <header class="panel-heading"><h4><b>Share Capital</b></h4></header>
                    <div class="panel-body">
                        ...
                        <div class="form">
                            ...
                            <div class="form-group ">
                                <!-- <input type="hidden" name="memb" value="<?php //echo $member; ?>  " /> -->
                          ...
                          <div class="panel-body">
                              <div class="form-group">
                                  <div class="col-lg-offset-2 col-lg-6">
                                      <input class="btn btn-primary" type="submit" name="invest" value="Save">
