...
<h5><b>Home Address: </b>  <?php echo $homeAddress; ?> </h5>
<h5><b>Current Address: </b>  <?php echo $currentAddress; ?> </h5>
...
<div class="modal-dialog modal-lg">
   <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            action="editContactInfo.php"> <!--once save is clicked, it will be redirected to the same page-->
