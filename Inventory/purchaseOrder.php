...
<section id="container" class="">   
    ...
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><br>PURCHASE ORDER RECORDS</h1>
            </div>
        </div>
        ...
        <form class="w3-container" action="" style="padding-bottom: 2%">
            <div class="w3-section">
                ...
                <input class="search w3-input w3-border w3-margin-bottom" type="text" id="myInput" list="supplier" name="supplier" placeholder="Search Supplier's Name" style="background-color: #fff; color: black">
            ...
            <table class="table table-striped table-advance table-hover"  id="userTbl" style="font-size: 20px">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><?php echo $row1['PONum']; ?></td>
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-primary" href="viewOrders.php?PONum=<?php echo $PONum; ?>" style="font-size: 20px">See Orders</a>
                            </div>
                        </td>
                    </tr>
